  ...
  <div class="container row">
    <div class="col-12 col-lg-6 d-flex flex-column flex-lg-row">
      ...
      <div class="col-12 col-lg-10 text-blue ff-main px-4">
        ...
        <p class="small">
          VP Hà Nội: 69 Hoàng Quốc Việt, P. Nghĩa Đô, Q. Cầu Giấy, Hà Nội.
        </p>
        <p class="small">
          VP TP. Hồ Chí Minh:  62 Nguyễn Bá Tuyển, Phường 12, Quận Tân Bình, Thành phố Hồ Chí Minh
        </p>
        <div class="bg-dark-blue rounded-3 p-2 text-light d-inline">
          Tổng đài CSKH
    ...
    <div class="col-12 col-lg-6 d-flex flex-column flex-lg-row">
      ...
      <div class="col-12 col-lg-6">
        ...
        <blockquote cite="https://www.facebook.com/thdtravel.event" class="fb-xfbml-parse-ignore">
            <a href="https://www.facebook.com/thdtravel.event">THD GROUP | Hanoi</a>
        </blockquote>
    </div>
      </div>
    </div>
    ...
    <div class="col-12 d-flex flex-column">
      <div class="text-uppercase d-flex justify-content-center gap-3">
        <a href="#" class="nav-link ff-main fw-bold">
          THD Events
        </a>
        <a href="#" class="nav-link ff-main fw-bold">
          THD Travel
      ...
      <div class="text-uppercase d-flex align-items-center justify-content-center gap-3">
        <div class="w-100 text-dark-blue">
...
<div class="position-fixed bottom-0 end-0">
    <div class="d-flex flex-column gap-3 pb-5 pe-4 mb-5">
        <a target="_blank" href="tel:0968342020" class="btn-cta bg-danger">
            <i class="bi bi-telephone fs-5"></i>
        </a>
        <a target="_blank" href="https://messenger.com" class="btn-cta bg-primary">
    ...
    <div class="login__item">
      ...
      <div class="login__form">
        <div class="login__variants">
          <label class="radio">
            <input class="radio__input" type="radio" name="login" checked="checked" /><span class="radio__inner"><span
                class="radio__tick"></span><span class="radio__text">Get the code by text message (SM) at +1 234 567
                890</span></span>
          </label>
          <label class="radio">
            <input class="radio__input" type="radio" name="login" /><span class="radio__inner"><span
                class="radio__tick"></span><span class="radio__text">Get the code by email at
                tranm••••••••••••@gm•••.com</span></span>
          </label>
        </div>
...
<script src="<?= URL ?>assets/js/lib/jquery.nice-select.min.js"></script>
<script src="<?= URL ?>assets/js/lib/share-buttons.js"></script>
<script src="<?= URL ?>assets/js/lib/jquery.fancybox.min.js"></script>
<script src="<?= URL ?>assets/js/lib/jquery.rateyo.min.js"></script>
<script src="<?= URL ?>assets/js/lib/nouislider.min.js"></script>
<script src="<?= URL ?>assets/js/lib/wNumb.js"></script>
<script src="<?= URL ?>assets/js/lib/jquery.magnific-popup.min.js"></script>
<script src="<?= URL ?>assets/js/lib/moment.min.js"></script>
<script src="<?= URL ?>assets/js/lib/jquery.daterangepicker.min.js"></script>
<script src="<?= URL ?>assets/js/lib/simpleParallax.min.js"></script>
<script src="<?= URL ?>assets/js/demo.js"></script>
<script src="<?= URL ?>assets/js/app.js"></script>
<script src="<?= URL ?>assets/js/slogan.js"></script>
<script src="<?= URL ?>assets/js/running_banner.js"></script>
<!-- svg sprite-->
