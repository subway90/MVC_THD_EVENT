...
<div style="background-color :#F1FAFF" class="container-fluid p-0 py-3 py-lg-5">
    ...
    <div class="container">
        ...
        <!-- Choose Place -->
        <div class="w-100 head-form-step-1 px-3 py-2 small">
            Địa điểm
        </div>
        <div class="w-100 d-flex flex-wrap align-items-center px-3 py-2 border mt-1">
            ...
            <div class="form-check col-12 col-lg-3">
                <input class="form-check-input" type="radio" name="place" id="place3">
                <label class="form-check-label" for="place3">
                    miền Nam
                </label>
            </div>
        </div>
        ...
        <!-- Choose Hotel -->
        <div class="w-100 head-form-step-1 px-3 py-2 small mt-5">
            Khách sạn
        </div>
        <div class="w-100 d-flex flex-wrap align-items-center px-3 py-2 border mt-1">
            <?php for ($i=0; $i < 15; $i++) : ?>
            <div class="form-check col-12 col-lg-4 mb-2">
                <input class="form-check-input" type="radio" name="hotel" id="hotel<?= $i ?>">
                <label class="form-check-label" for="hotel<?= $i ?>">
                    Flamingo Đại Lải Resort - Bĩnh Phúc
                </label>
            </div>
            <?php endfor ?>
        </div>
        ...
        <div class="w-100 text-center mt-4">
            <a href="/bao-gia-dich-vu/step-2" class="btn btn-ouline-light border small px-4">
                Trang sau
            </a>
        </div>
    </div>
